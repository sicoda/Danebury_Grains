...
if plot_morph_pca:
    ...
    axs[0,0].set_xlabel("Barley Spectrum PCA #%s"%(str(chem_pca_plot_component+1)))
    axs[0,1].set_xlabel("Spelt Spectrum PCA #%s"%(str(chem_pca_plot_component+1)))
    axs[0,0].set_ylabel("Barley Morph PCA #%s"%(str(morph_pca_plot_component+1)))
    axs[0,1].set_ylabel("Spelt Morph PCA #%s"%(str(morph_pca_plot_component+1)))
    axs[1,0].set_ylabel("Barley Morph Component Coeff")
    axs[1,1].set_ylabel("Spelt Morph Component Coeff")

    plt.savefig("Morph_PCA_%s_vs_Chem_PCA_%s.png"%(str(morph_pca_plot_component),str(chem_pca_plot_component)), dpi=300, bbox_inches='tight')
