...
colors = ['r', 'g']
compare = ['2B','3B'] #specify prefixes of groups to compare
...
plt.savefig("/Users/daniellesicotte/Library/Mobile Documents/com~apple~CloudDocs/Cambridge/MPhil Thesis/DATA/FTIR/FTIR_1.2/2B_3B.png",dpi=300,bbox_inches='tight')
plt.show()
