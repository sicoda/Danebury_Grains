...
directory = "/Users/daniellesicotte/Library/Mobile Documents/com~apple~CloudDocs/Cambridge/MPhil Thesis/DATA/NIR/NIR_Der/" #must contain only homogeneous TXT comma-separated files
colors = ['r', 'g']
...
axs[1].set_xlabel(r"Wavenlength [nm]")
...
plt.savefig("/Users/daniellesicotte/Library/Mobile Documents/com~apple~CloudDocs/Cambridge/MPhil Thesis/DATA/NIR/PCA_Der/4B_5B.png",dpi=300,bbox_inches='tight')
plt.show()
